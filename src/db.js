...
const { User, ShoppingCart, Order, CommentsRaiting,  Product, Category, Televisores } = sequelize.models;
...
Product.hasOne(Televisores,{onDelete: 'CASCADE' })
Televisores.belongsTo(Product,{onDelete: 'CASCADE' })
